...
// All these variables are empty before we assign to them. 
let svg;
...
* */
function init() {
    // our projection and path are only defined once, and we don't need to access them
    ...
    svg.on("mousemove", (e) => {
    // we can d3.pointer to tell us the exact x and y position of our cursor
